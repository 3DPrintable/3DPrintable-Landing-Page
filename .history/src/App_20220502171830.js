...
import { House, Group, ContactSupport, Map, Help, Extension, EmojiObjects, ArrowForward, Security, List, Twitter } from '@material-ui/icons'; //Work=Careers and Assignment=Whitepaper
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                                        ...
                                        <ul class="list-unstyled social-icon foot-social-icon mb-0 mt-4">
                                            <li><Twitter/><a href="/#" class="fea icon-sm fea-social"></a></li>
                                            <li><Icon icon="mdi:discord" /><a href="/#" class="fea icon-sm fea-social"></a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="col-lg-2 col-md-4 col-16 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                        ...
                                        <ul class="list-unstyled footer-list mt-4">
                                            ...
                                            <li><Help/><a href="FAQs" class="sub-menu-item">FAQs </a></li>
                                            <li><ContactSupport/><a href="Contact" class="sub-menu-item">Contact Us</a></li>
                                            <li><Security/><a href="/#" class="sub-menu-item">Privacy Policy</a></li>
                                            <li><List/><a href="/#" class="sub-menu-item">Terms and Conditions</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
