                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-8">
                                <div class="text-sm-start text-center">
                                    ...
                                    <a href={Privacy_Policy} target="_blank" rel="noopener noreferrer" class="sub-menu-item">Privacy Policy</a>
                                    <a href={Terms} target="_blank" rel="noopener noreferrer" class="sub-menu-item">Terms</a></li>
                                </div>
                            </div>
                        </div>
                    </div>
